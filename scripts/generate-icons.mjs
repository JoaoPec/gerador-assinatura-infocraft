...
save(
  ...
  drawContactIcon((ctx) => {
    ...
    ctx.moveTo(9.5, 4);
    ctx.lineTo(14.5, 4);
    ctx.quadraticCurveTo(16, 4, 16, 5.5);
    ctx.lineTo(16, 18.5);
    ctx.quadraticCurveTo(16, 20, 14.5, 20);
    ctx.lineTo(9.5, 20);
    ctx.quadraticCurveTo(8, 20, 8, 18.5);
    ctx.lineTo(8, 5.5);
    ctx.quadraticCurveTo(8, 4, 9.5, 4);
    ctx.closePath();
    ctx.stroke();

    ctx.fillRect(11, 18, 2, 1.5);
  })
);
